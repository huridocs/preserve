...
beforeAll(async () => {
  ...
  config.cookiesPath = `${__dirname}/specs/testing_files/cookies/${testName}-lastRun`;
...
afterAll(async () => {
  ...
  try {
    await rmdir(config.cookiesPath);
  } catch (e) {}
  try {
